...
# Code from https://github.com/speciationgenomics/scripts/blob/master/ld_decay_calc.py
# Physalia December 2021 course run by Mark Ravinet & Joana Meier.
# Converted to python3 from python2 by chatgpt (which is insane that is worked first time)
