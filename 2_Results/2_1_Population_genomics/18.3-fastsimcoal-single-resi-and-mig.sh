...
analysis_name=SFS_${SLURM_ARRAY_TASK_ID}_sigMandS_${foldtype}
...
cp $output_dir/SFS/SFS_${SLURM_ARRAY_TASK_ID}/SFS_sigMandS_$foldtype/fastsimcoal2/*joint*.obs ./
...
echo "TDivAncs@ $(awk '$1=="resi" {print NR-1}' $output_dir/SFS/SFS_${SLURM_ARRAY_TASK_ID}/pop_sigMandS_uniq.txt) $(awk '$1=="anad" {print NR-1}' $output_dir/SFS/SFS_${SLURM_ARRAY_TASK_ID}/pop_sigMandS_uniq.txt) 1 RESIZE1 0 0" >> $output_model/${analysis_name}.tpl
