...
if [ $SLURM_ARRAY_TASK_ID == "1" ]; then
   ...
   echo -e "OBSE\nDUIN\nLUIB\nCLAC\nOLAV\nTORM" > $output_dir/Pops_interest.txt
...
if [ $run_analysis == "TRUE" ]; then
   ...
   Rscript /gpfs01/home/mbzcp2/code/Github/stickleback-Uist-species-pairs/2_Results/2_1_Population_genomics/10.31-calculate-sliding-window-pca.R \
...
if [ $pcafilesNo == 21 ]; then
   ...
   ## Plot in R
   Rscript /gpfs01/home/mbzcp2/code/Github/stickleback-Uist-species-pairs/2_Results/2_1_Population_genomics/10.32-plot-sliding-window-pca.R \
